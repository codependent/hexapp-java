...
class DepartmentControllerTests {
    ...
    void shouldCreateDepartment() throws Exception {
        ...
        when(createDepartmentUseCase.createDepartment(createDepartmentCommand))
                .thenReturn(Department.create(createDepartmentCommand.id(), createDepartmentCommand.name()));
    ...
    void shouldFailCreatingInvalidDepartment() throws Exception {
        ...
        when(createDepartmentUseCase.createDepartment(createDepartmentCommand))
                .thenReturn(Either.left(new ValidationErrors(List.of(
                        invalidField,
                        invalidField2))));
    ...
    void shouldFailCreatingExistingDepartment() throws Exception {
        ...
        val createDepartmentCommand = new CreateDepartmentCommand(0, "name");
        when(createDepartmentUseCase.createDepartment(createDepartmentCommand))
                .thenReturn(Either.left(new DepartmentExistsError("name")));
    ...
    void shouldFailCreatingBlacklistedDepartment() throws Exception {
        ...
        val createDepartmentCommand = new CreateDepartmentCommand(0, "name");
        when(createDepartmentUseCase.createDepartment(createDepartmentCommand))
                .thenReturn(Either.left(new DepartmentBlacklistedError("name")));
